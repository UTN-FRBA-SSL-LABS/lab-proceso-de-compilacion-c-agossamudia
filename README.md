...
El número es mayor que 94 porque el preprocesador abrió las directivas y copió su contenido en programa.i> **R:**
...
No devuelve nada porque el preprocesador elimina todos los comentarios en su procesamiento> **R:**
...
Sin -DDEBUG: La salida es vacía, Con -DDEBUG:printf("[DEBUG] %s\n", ("Iniciando main")); > **R:**
...
Comunican el origen de cada bloque de código en el archivo. La declaración de printf proviene del archivo "c:\\mingw\\include\\stdio.h" > **R:**
...
.ascii "area_circulo(%.1f) = %.4f\12\0"
        call    _area_circulo
        .def    _area_circulo;  .scl    2;      .type   32;     .endef> **R:**
...
**R:** area_circulo tiene U en programa.o porque este programa llama a la funcion sin saber su desarrollo, en matematica.o aparece con T porque tiene la definición de la función>
...
> **R:** Quedan porque son funciones que vienen de bibliotecas dinámicas y el enlazador dejó una referencia al nombre de la biblioteca que las contiene. Estos simbolos se resuelven en tiempo de ejecución a través del cargador dinámico. 
...
> **R:** Una macro función se sustituye cuando se ejecuta el preprocesador, toma la función y la reemplaza por su expansión. Una función real se traduce por el compilador a instrucciones. La macro función desaparece en la etapa de preprocesamiento, y la función real es la que tiene verificación de tipos.
...
> **R:** Un símbolo de tipo T corresponde a código ejecutable, una función definida en el archivo, y vive en la sección .text . Un símbolo de tipo D corresponde a una variable global,  vive en la sección .data . La diferencia es que T son instrucciones que la CPU ejecuta, mientras que D son datos que el programa lee o escribe durante su ejecución.
